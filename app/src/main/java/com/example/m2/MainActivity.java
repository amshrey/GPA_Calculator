...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gradeLayouts.add(findViewById(R.id.editText));
        gradeLayouts.add(findViewById(R.id.editText5));
        gradeLayouts.add(findViewById(R.id.editText2));
        gradeLayouts.add(findViewById(R.id.editText4));
        gradeLayouts.add(findViewById(R.id.editText3));
    ...
    public void computeGPA(View view) {
        if (!isInvalidOrEmpty(gradeLayouts)) {
            ...
            Button btnGPA = findViewById(R.id.btn_GPA);
            btnGPA.setText("Clear Form");

            // Set Background color as per GPA value
            ConstraintLayout conLayout = findViewById(R.id.constraint_1);
